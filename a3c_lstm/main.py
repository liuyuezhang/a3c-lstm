...
from a3c_lstm.train import train
from a3c_lstm.test import test
from a3c_lstm.shared_optim import SharedRMSprop, SharedAdam
...
if __name__ == '__main__':
    ...
    shared_net = A3C_LSTM(env.observation_space.shape[0], env.action_space.n)
